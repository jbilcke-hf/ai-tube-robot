import {deleteReq, post, get, jsonGet, audioGet, fullJsonPost, audioPost, jsonPost} from "./apiHandler.mts";
import {buildFormData, buildProjectFormData, saveBlobToFile, saveZip} from "./util.mts";
...
class ElevenLabs {
    ...
    async tts(
        ...
        params: {output_format: string, optimize_streaming_latency: number } = {
    ...
    async #voiceFunc(name, optionalSettings: any = {}, voiceId = ""){
     ...
     * @return voiceId
     */
    async addVoice(name, filePaths, optionalSettings: any = {}){
